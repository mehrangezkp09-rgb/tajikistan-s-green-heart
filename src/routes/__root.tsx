...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "SabzTajik — 3D-симулятор экологии Таджикистана" },
      { property: "og:description", content: "Интерактивная 3D-платформа о природе, лесах и экологических вызовах Таджикистана." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "SabzTajik — 3D-симулятор экологии Таджикистана" },
      { name: "twitter:description", content: "Интерактивная 3D-платформа о природе, лесах и экологических вызовах Таджикистана." },
    ],
    links: [
